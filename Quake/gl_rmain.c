...
cvar_t	r_nolerp_list = {"r_nolerp_list", "mdls/flame.mdl,mdls/flame2.mdl,mdls/braztall.mdl,mdls/brazshrt.mdl,mdls/longtrch.mdl,mdls/flame_pyre.mdl,mdls/v_saw.mdl,mdls/v_xfist.mdl,mdls/h2stuff/newfire.mdl", CVAR_NONE};
cvar_t	r_noshadow_list = {"r_noshadow_list", "mdls/flame2.mdl,mdls/flame.mdl,mdls/bolt1.mdl,mdls/bolt2.mdl,mdls/bolt3.mdl,mdls/laser.mdl", CVAR_NONE};
